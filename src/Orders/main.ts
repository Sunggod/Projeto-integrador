...
async function main() {
    ...
    await orderService['init'](); // Chamando o método privado init
        ...
        try {
            switch (option) {
                case '1': {
                    ...
                    // Aqui você pode buscar os produtos pelo ID, ou usar IDs simples
                    ...
                    const orderDto: OrderDto = {
                        ...
                        startDate,
                        deliveryDate,
                        DataProcessing: dataProcessing,  // Corrigido para usar 'DataProcessing'
                        status,
                    };
